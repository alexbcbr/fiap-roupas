...
/**
 * The Aplicação que chama todas as janelas da funcionalidade de consulta
 * @author alexbc
 * @version 1.0
 */
public class RealizarConsultaSWT {

	/** Abstração que representa a janela de top-level da aplicação */
	protected Shell shell;
	
	/** pagina de composição do fluxo de nevegacao das telas */
	...
	/**
	 * Montado o desenho da tela e anexado todos os composites que farão parte da navegação da aplicação.
	 */
